"""Knowledge Graph builder from existing indexing output.

This module builds KnowledgeNodes and KnowledgeEdges from:
- Documents (FILE nodes)
- Symbols (SYMBOL nodes)
- Symbol relationships (edges)

It integrates with the sync pipeline to run after indexing completes.
"""
